...
describe('syncCucumberTests', () => {
	...
	it('should create new ticket if scenario is not present', async () => {
		...
		const createNewTicketBody = {
			fields: {
				...
				[xrayFieldIds.xrayCucumberTestFieldId]: { id: xrayFieldIds.xrayCucumberTestTypeMappings[parsedData.scenarioType] },
	...
	it('should update existing ticket if scenario requires an update', async () => {
		...
		const updateExistingTicketBody = {
			fields: {
				[options.xrayCucumberTestFieldId]: { id: options.xrayCucumberTestTypeMappings[parsedData.scenarioType] },
