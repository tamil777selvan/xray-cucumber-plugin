...
const getIssueTypeMetadataResponse = (issueTypeId: number) => {
    ...
    const issueTypeValues = {
		...
		'Xray Test': [
			{
				required: false,
				schema: { type: 'option', custom: 'com.xpandit.plugins.xray:test-type-custom-field', customId: 19011 },
				name: 'Test Type',
			...
			{
				required: false,
				schema: { type: 'option', custom: 'com.xpandit.plugins.xray:automated-test-type-custom-field', customId: 19012 },
			...
			{
				required: false,
				schema: { type: 'string', custom: 'com.xpandit.plugins.xray:steps-editor-custom-field', customId: 19013 },
			...
			{
				required: false,
				schema: { type: 'string', custom: 'com.xpandit.plugins.xray:path-editor-custom-field', customId: 19014 },
			...
			{
				required: false,
				schema: { type: 'any', custom: 'com.xpandit.plugins.xray:manual-test-steps-custom-field', customId: 19015 },
			...
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:test-sets-custom-field', customId: 19018 },
			...
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:test-precondition-custom-field', customId: 19019 },
			...
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:test-plans-associated-with-test-custom-field', customId: 19020 },
			...
			{
				required: false,
				schema: { type: 'any', custom: 'com.xpandit.plugins.xray:test-repository-path-custom-field', customId: 19022 },
		...
		'Xray Test Set': [
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:test-sets-tests-custom-field', customId: 19023 },
		...
		'Xray Test Execution': [
			{
				required: false,
				schema: { type: 'array', items: 'string', custom: 'com.xpandit.plugins.xray:test-environments-custom-field', customId: 19036 },
			...
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:testexec-tests-custom-field', customId: 19026 },
			...
			{
				required: false,
				schema: { type: 'array', custom: 'com.xpandit.plugins.xray:test-plan-custom-field', customId: 19038 },
				name: 'Test Plan',
