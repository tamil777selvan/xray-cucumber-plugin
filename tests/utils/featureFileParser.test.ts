...
describe('validateScenarioNames', () => {
	it('Valid scenario names should not throw an error', () => {
		const parsedData = [
			{ tags: '', scenarioType: 'Scenario', scenarioName: 'Scenario 1', scenarioSteps: '' },
			{ tags: '', scenarioType: 'Scenario', scenarioName: 'Scenario 2', scenarioSteps: '' }
		];
	...
	it('Scenario names with more than 250 characters should throw an error', () => {
		const parsedData = [{ tags: '', scenarioType: 'Scenario', scenarioName: 'A'.repeat(251), scenarioSteps: '' }];
