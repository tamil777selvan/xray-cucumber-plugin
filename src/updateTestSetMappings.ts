...
export const updateTestSetMappings = async (options: Options) => {
    try {
        logger.info('XRAY: Updating Test Sets Task Started...');
        ...
        logger.info('XRAY: Updating Test Sets Task Completed...');
